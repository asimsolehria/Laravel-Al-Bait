...
<div class="content">
    <div class="block">
        <div class="block-header"><h3>Add AccountType</h3></div>
        ...
        {!! Form::open(array('route' => 'hr.bankaccounttype.store','method'=>'POST')) !!}
                @csrf
                ...
                <div class="col-lg-8 col-xl-5">
                    ...
                    <a href="{{ route('hr.bankaccounttype.index')}}" class="btn btn-rounded btn-dark">Back</a>
                </div>
                {!! Form::close() !!}
        </div>
    </div>
