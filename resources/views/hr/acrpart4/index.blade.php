...
<div class="block">
    <div class="block-header">
        <h3 class="block-title">Appraisal part 4 Cases</h3>
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                <thead>
                    <tr>
                        ...
                        <th class="p-3 mb-2 bg-success text-white">AcrID</th>
                ...
                <tbody>
                    @foreach($acremployeepart as $key=>$acremployeerecords)
                    ...
                    {{-- <td class="text-center font-size-sm">{{$key+1}}</td> --}}
                        ...
                        <td class="font-w600 font-size-sm">
                        <a href="be_pages_generic_blank.html">{{$acremployeerecords->RO1Status}}</a>
                        </td>
                            ...
                            {{-- <a href="{{route('hr.designation.edit', ['id' => $Designation->DesignationID])}}" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Edit">
                                <i class="fa fa-pencil-alt"></i>
                                    ...
                                    <a id="{{$Designation->DesignationID}}" href="#" class="btn btn-sm btn-danger del-Cont" data-toggle="tooltip" title="Delete Item">
                                        ...
                                        <a href="{{route('hr.acrpart4.create', ['id' => $acremployeerecords->ACRID])}}"  id="{{ $acremployeerecords->ACRID}}" class="btn btn-sm btn-success" style="padding: 4px 8px;" data-toggle="tooltip" title="Add Employe Appraisals">
                                            <i class="far fa-plus-square"></i>
                                          </a>
                                        <a href="{{route('hr.hrreport.report', ['id' => $acremployeerecords->ACRID])}}"  id="{{ $acremployeerecords->ACRID}}" class="btn btn-sm btn-warning" style="padding: 4px 8px;" data-toggle="tooltip" title="Add Employe Appraisals">
                                            <i class="far fa-plus-square"></i>
                                          </a>
