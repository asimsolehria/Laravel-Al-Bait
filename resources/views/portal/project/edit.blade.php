...
<div class="card bcard mt-2 mt-lg-3">
     <div class="card-header">
          <h3 class="card-title text-125">
               ...
               Upate Project Detail's
          </h3>
     </div>
     <div class="card-body px-3 pb-1">
          <form class="mt-lg-3" autocomplete="off"
               action="{{route('project.update', $data->ProjectId )}}" method="post">
               ...
               <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                         <input type="text" class="form-control col-sm-8 col-md-6"
                              value="{{$data->Project_Code}}" name="Project_Code" id="AccountCode"
               ...
               <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                         <input type="text" class="form-control col-sm-8 col-md-6"
                              value="{{$data->Project_title}}" name="Project_title" id="AccountName">
                    </div>
               </div>
               <div class="form-group row">
                    <div class="col-sm-3 col-form-label text-sm-right required pr-0">
                    ...
                    <div class="col-sm-9">
                         <input type="text" class="form-control col-sm-8 col-md-6"
                              value="{{$data->location}}" name="location" id="AccountName">
                    </div>
               </div>
               <div class="form-group row">
                    <div class="col-sm-3 col-form-label text-sm-right required pr-0">
                    ...
                    <div class="col-sm-9">
                         <input type="text" class="form-control col-sm-8 col-md-6"
                              value="{{$data->Project_Overview}}" name="Project_Overview" id="AccountName">
                    </div>
               </div>
