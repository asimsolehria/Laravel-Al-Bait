          ...
          <div class="card bcard">
               <div class="card-body px-1 px-md-3">
                    <div class="d-flex justify-content-between flex-column flex-sm-row mb-3 px-2 px-sm-0">
                         <h3 class="text-130 pl-1  mb-3 mb-sm-0">Chart of Account</h3>
                         
                         @can('chartofaccount-create')
                         <div class="mb-2 mb-sm-0 d-print-none">
                              <a class="btn btn-outline-success"
                                   href="{{ route('chartofaccount.create') }}"><i
                                        class="fa fa-fw fa-plus mr-1"></i> Add Chart</a>
                         </div>
                         @endcan
                    </div>
                    ...
                    <table id="simple-table"
                         ...
                         <thead class="text-white-tp3 text-90 border-b-1 brc-transparent bgc-success-m1">
                              <tr>
                                   <th width="164px">Account Name</th>
                                   <th>Account Code</th>
                                   <th>Description</th>
                                   <th class="d-none d-sm-table-cell">Is First Level</th>
                                   <th class="d-none d-sm-table-cell">Level</th>
                                   <th class="d-none d-sm-table-cell">Parent Code</th>
                                   <th class="d-none d-sm-table-cell">Is Transaction</th>
                         ...
                         <tbody class="mt-1">
                              ...
                              <tr class="bgc-h-yellow-l4 d-style">
                                   <td>
                                        <a href="{{route('chartofaccount.nextlevel', $item->Account_Code )}}"
                                   ...
                                   <td class="d-none d-sm-table-cell">
                                        @if(isset($item->Is_Transaction) and $item->Is_Transaction==1) <span
                                             class="text-success">Yes</span>
                                        @else <span class="text-info">No</span>
                                        @endif
                                   </td>
                                   <td class="d-none d-sm-table-cell">
                                        @if(isset($item->Is_Active) and $item->Is_Active==1) <span
                                             class="text-success">Yes</span>
                                        @else <span class="text-info">No</span>
                                        @endif
                                   </td>
                                   <td>
                                        <div class="d-lg-flex d-print-none">
											...
											<i class="fa fa-eye text-info-d2"></i>
                                             ...
                                             <a href="{{route('chartofaccount.edit', $item->SeqID)}}"
                                                  class="mx-3px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-orange btn-a-lighter-orange">
                                             ...
                                             <form method="POST" id="delete-gender-form"
                                                  action="{{route('chartofaccount.destroy', $item->SeqID)}}"
                                                  style="display:none">
                                                  @csrf
