                        ...
                        <div class="carousel-item active minw-100 h-100">
                          ...
                          <div style="background-image: url({{asset('assets/image/login-bg-1.svg')}});" class="px-3 bgc-blue-l4 d-flex flex-column align-items-center justify-content-center">
                            <a class="mt-5 mb-2" href="html/dashboard.html">
                              <i class="fa text-success-m2 fa-3x">
                                <img src="{{asset('assets/image/custom/logo.png')}}" width="200px" height="100px">
                              </i>
                            </a>

                            <h3 class="text-primary-d1">
                              {{__('trans.lms')}}{{-- <span class="text-80 text-dark-l1">Application</span>--}}
...
{{--                                  <i class="far fa-trash-alt text-110 text-orange-d1 mr-1 w-2"></i>--}}
                            ...
                            <div class="mt-auto mb-4 text-dark-tp2">
                              BridgeSoft Technologies Pvt. Ltd. Pakistan &copy; 2021
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="tab-pane active show mh-100 px-3 px-lg-0 pb-3" id="id-tab-login">
                        ...
                        <div class="d-lg-none text-secondary-m1 my-4 text-center">
                          <a href="html/dashboard.html">
                            <i class="fa text-success-m2 text-200 mb-4">
                              <img src="{{asset('assets/image/custom/logo.png')}}" width="200px" height="100px">
                            </i>
                          </a>
                          <h1 class="text-170">
            ...
            <div class="d-lg-none my-3 text-white-tp1 text-center">
              <i class="fa fa-leaf text-success-l3 mr-1 text-110"></i> Bridge Soft Technologies (SMC-Private) Limited Pakistan &copy; 2021
            </div>
          </div>
        </div>
